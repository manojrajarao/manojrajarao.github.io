...
-   If enough balls are dropped into this maze we begin to get a distribution of balls similar to that in Figure ![Normal Distribution](../images/dist/normal_dist.jpeg){:.foo}
